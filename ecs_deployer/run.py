...
parser.add_argument("-p", "--procfile", type=str, required=False)
parser.add_argument("-i", "--image", type=str, required=True)
parser.add_argument("-c", "--container", type=str, required=False)
...
if __name__ == "__main__":
    ...
    try:
        main(procfile_path=args.procfile, ecr_image=args.image, container_definitions=args.container)
    except Exception as e:
